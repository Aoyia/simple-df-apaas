...
const HTTP_ERROR_CONSTANT = {
  ...
  [HTTP_STATUS_CODE.MethodNotAllowed]: new HttpError(
    ...
    "Method Not Allowed 请求方法（GET、POST等）对指定的资源不使用"
  ),
  [HTTP_STATUS_CODE.NotAcceptable]: new HttpError(
    HTTP_STATUS_CODE.NotAcceptable,
    "Not Acceptable 指定的资源已经找到，但是MIME类型和客户在Accept头中所指定的不兼容"
  ),
  ...
  // 600 ~ 出现未知异常
  [HTTP_STATUS_CODE.UnknownError]: new HttpError(
    HTTP_STATUS_CODE.UnknownError,
    "Unknown Error 出现了未知错误,  请联系管理员"
  ),
};
